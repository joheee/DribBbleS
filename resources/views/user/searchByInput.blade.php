...
@section('title','Trending Animations, Motion Graphics, and 3D designs on | dribbbles')

@section('inner-content')

    <main role="main" style="min-height: 100vh; bg-light">
        <div style="background-color: #f1cdd7; display:flex; justify-content: center; position: relative">
            <img src={{asset('storage/assets/LoginBanner.jpg')}} class="img-fluid" style="max-height: 366px">
            <div class="container" style="color: white; background-color: rgba(0, 0, 0, 0.3); width: fit-content; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); ">
                <h1 class="jumbotron-heading text-center mb-0 px-2 py-2">
                    {{count($posts)}} result for "{{$search}}"</h1>
            </div>
